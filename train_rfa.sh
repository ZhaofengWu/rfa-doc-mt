...
path=${OUTPUT_DIR}
random_matrices_path=$(pwd)/random_matrices
...
--arch rfa_transformer_iwslt_de_en \
...
--random-matrices-path ${random_matrices_path} \
--cross-proj-dim ${CROSS_DIM} \
--causal-proj-dim ${CAUSAL_DIM} \
--cross-tau 1.0 \
--causal-tau 1.0 \
--init-scale 6.0 \
--learned-tau \
